...
/**
 * @author Martin Schram Container for elevator actions.
 */
public class ElevatorActions {
	...
	/**
	 * ctor with init of all members for Actions to be set onto the elevator on a
	 * cycle
	 */
	...
	/**
	 * Set the Targetfloor Property to be set by gui-binding
	 */
	public int TargetFl;

	/**
	 * Set the ComitedDir Property to be set by gui-binding
	 */
	public boolean CommitedDirIsUp;

	/**
	 * Set Automode Property to be set by gui-binding
	 */
	public boolean AutoMode;

	/**
	 * Set Servicefloors directly Property to be set by gui-binding
	 */
